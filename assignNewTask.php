						...
						<div class="form-group">
							<label for="typeOfForm">Assign To</label>
							  <select class="form-control" name="assignedTo">
								  <option value="">--</option>
								  <option value="Christian Paul Duria">Christian Paul Duria</option>
								  <option value="Demeter Renee Caubang">Demeter Renee Caubang</option>
								  <option value="Jan Laurene Manrique">Jan Laurene Manrique</option>
								  <option value="Trisha Nicole Tolentino">Trisha Nicole Tolentino</option>
							  </select>
							</div>
						<div class="form-group">
