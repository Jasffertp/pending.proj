...
<div class="main_content" style="padding:3%;"> 
    ...
    if(isset($_GET['status']) && $_GET['status'] == 'submitted')
    {
    	?>
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Hey!</strong> Status report submitted succesfully
    ...
    <div class="info">
		...
		if('HVAC' == $row_equipment['asset']) { ?>
			<form action="viewStatusReportHVAC.php?r_id=<?php echo $row_report['report_id'];?>&e_id=<?php echo $row_report['machine_id'];?>&d_id=<?php echo $row_report['date_created'];?>" method="post">
				<div class="row">
	              <div class="col-4">
		...
		<?php }else { ?>
			<form action="viewStatusReportGenSet.php?r_id=<?php echo $row_report['report_id'];?>&e_id=<?php echo $row_report['machine_id'];?>&d_id=<?php echo $row_report['date_created'];?>" method="post">
			<div class="row">
