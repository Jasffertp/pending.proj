<?php
	...
	$sql_i = "SELECT * FROM `issue`,`equipment`,`users` WHERE issue.machine_id = equipment.equipment_id AND issue.assigned_to = users.users_id ORDER BY date_due ASC LIMIT ".$min.",10";
